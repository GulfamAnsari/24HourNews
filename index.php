        ...
        <div class="row header-content">
            ...
            <nav id="main-nav-wrap">
                <ul class="main-navigation sf-menu">
                    <li><a  class="current navHeading" href="/"><i class="fa fa-home" style="padding-right:5px"></i>Top Stories</a></li>
                ...
                <div class="brick entry featured-grid animate-this">
                    <div class="entry-content">
                        <div id="featured-post-slider" class="flexslider">
                            <ul class="slides">
                                <?php	$xml=simplexml_load_file("https://www.miaminewtimes.com/index.rss") or die("Error: Cannot create object");
                                ...
                                <li>
                                    <div class="featured-post-slide">
                                        ...
                                        <div class="post-background"
                                            style="background-image:url(<?php echo $item->enclosure['url']; ?>);">
                                        </div>
                    ...
                    <article class="brick entry format-standard animate-this">
                        ...
                        <div class="entry-thumb">
                            ...
                            <a href=<?php echo $a['href'];?> class="thumb-link">
                                <img src=<?php echo $item->enclosure['url'];?> alt="USAF rocket">
                            </a>
                        </div>
