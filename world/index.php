                ...
                <div class="brick entry featured-grid animate-this">
                    <div class="entry-content">
                        <div id="featured-post-slider" class="flexslider">
                            <ul class="slides">
                                <?php	$xml=simplexml_load_file("http://www1.cbn.com/app_feeds/rss/news/rss.php?section=world");
                                ...
                                <li>
                                    <div class="featured-post-slide">
                                        ...
                                        <div class="post-background"
                                            style="background-image:url(<?php echo $item->thumbnail; ?>);">
                                        </div>
                    ...
                    <article class="brick entry format-standard animate-this">
                        ...
                        <div class="entry-thumb">
                            ...
                            <a href=<?php echo $item->link;?> class="thumb-link">
                                <img src=<?php echo $item->thumbnail;?> alt="USAF rocket">
                            </a>
                        </div>
